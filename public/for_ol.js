var mapView = new ol.View({
    center: ol.proj.fromLonLat([125.568014,8.890400]), //Butuan City Center Coordinates
    zoom: 12,
});
...
var mousePosition = new ol.control.MousePosition({  //mouse position coordinates
        ...
        if(featureInfoFlag){
            ...
            if(url){
                $.getJSON(url, function(data){
                    ...
                    content.innerHTML = "<h2> Barangay: </h2> <p>" + props.barangay.toUpperCase() +
                    "</p> <br> <h2> Class: </h2> <p>" + props.class + "</p>" + 
                    "</p> <br> <h2> Area: </h2> <p>" + props.shape_area + "</p>";
...
lengthButton.innerHTML = '<img src = "images/controls/length.png" alt = "LENGTH" style= "width:20px;height:20px;filter:britghtness(0);vertical-align:middle"></img>';
 ...
 *@type {import("../0l/Feature.js").default}
 */
var sketch;
...
//Codeium:Refactor|Explain|GenerateJSDoc
    ...
    document.getElementById("selectLayer").onchange = function () { 
        ...
        $(document).ready(function(){
            $.ajax({
                ...
                datatype: "xml",
//                Codeum Refactor | Explain | Generate 15Doc
                success: function(xml){
 ...
 function newpopulateQueryTable(url){
    ...
    $.getJSON(url, function (data){
        ...
        //CREATE HTML TABLE HEADER ROM USING THE EXTRACTED HEADERS ABOVE.
        ...
        //ADO SON DATA TO THE TABLE AS ROWS.
